 ...
 */
package com.adobe.livecycle.samples.ibmcm.eClient.util;
...
public class RequestUtil {
    ...
    public static String getEnvironBuffer(HttpServletRequest request)
    {
        ...
        sEnvironBuffer
        += addVariable(request, "Accept-Language", "HTTP_ACCEPT_LANGUAGE");
        sEnvironBuffer
        += addVariable(request, "Accept-Encoding", "HTTP_ACCEPT_ENCODING");
